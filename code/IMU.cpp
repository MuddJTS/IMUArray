...
MPU9250 IMU1(MPU9250_ADDRESS_AD0, I2Cport, I2Cclock);
MPU9250 IMU2(MPU9250_ADDRESS_AD1, I2Cport, I2Cclock);
...
void setup()
{
  ...
  if (c == 0x71) // WHO_AM_I should always be 0x71
  {
    ...
    if (d != 0x48)
    {
      ...
      Serial.println(F("Communication with magnatomitor failed, abort!"));
      Serial.flush();
      abort();
    }
